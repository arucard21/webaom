...
public class Anime extends Base {
    ...
    public Anime(String[] s) {
        ...
        } else { // Data is From the serialize File
            yen = yea;
        }
        typ = s[i++];
        rom = s[i++];
    ...
    public String toString() {
        return switch (Anime.TPRI) {
        case 1 -> (kan == null ? rom : kan) + " (" + eps + ":" + lep + ")";
        case 2 -> (eng == null ? rom : eng) + " (" + eps + ":" + lep + ")";
        default -> rom + " (" + eps + ":" + lep + ")";
        };
    }
    ...
    public String serialize() {
        return "" + id + Base.S + eps + Base.S + lep + Base.S + yea + Base.S + typ + Base.S + rom + Base.S + kan
                + Base.S + eng + Base.S + cat + Base.S + yen;
    }
    ...
    public char miss() {
        /*
         * if(!pro.hole()) return ' '; return pro.last()?!pro.first()?'F':'L':'H';
         */
