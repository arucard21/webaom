...
public class ChiiEmu implements CommandModel {
    ...
    private class EmuWorker extends Thread {
        ...
        public String lookUp(String s) throws AConEx {
            ...
            // if(mScmd.startsWith("!stats")) return stats(m_ac.send("STATS", null,
            // true).data);
            ...
            if (mScmd.startsWith("!state2")) {
                return stosta(s.substring(7).trim(), ChiiEmu.I_STAT2);
            }
            ...
            if (mScmd.startsWith("!storage")) {
                return stosta(s.substring(8).trim(), ChiiEmu.I_STORA);
            }
        ...
        public String stosta(String p, int t) throws AConEx {
            ...
            if (ChiiEmu.I_STORA == t) {
                ...
                if ("unknown".equalsIgnoreCase(a[3])) {
                    sb.append(0);
                } else if ("hdd".equalsIgnoreCase(a[3])) {
                    sb.append(1);
                } else if ("cd".equalsIgnoreCase(a[3])) {
                    sb.append(2);
                } else if ("deleted".equalsIgnoreCase(a[3])) {
                    sb.append(3);
                } else {
        ...
        public String randomanime(String param) throws AConEx {
            ...
            if ("watched".equals(param)) {
                type = 1;
            } else if ("unwatched".equals(param)) {
                type = 2;
...
//		}
        ...
        /**
         * !state <anime> <ep#> <state> !state <anime> all <state> !state <anime> upto
         * <ep#> <state> !state <anime> last <state> !state <fid> <state> !state <ed2k
         * link> <state> !state last <state>
         *
        ...
        public String watched(String s) {
            ...
            try {
                ...
                if (j >= 0) {
                    ...
                    api.append("&size=").append(a[1]);
                    api.append("&ed2k=").append(a[2]);
                } else {
                    int epno = 0;
                    j = s.indexOf(" none");
                    ...
                    if (anime.length() < 1) {
                        ...
                        api.append("&fid=").append(epno);
                    } else {
                        api.append("&epno=").append(epno);
        ...
        public String state(String s) {
            ...
            try {
                ...
                if ("unknown".equalsIgnoreCase(statestr)) {
                    state = 0;
                } else if ("hdd".equalsIgnoreCase(statestr)) {
                    state = 1;
                } else if ("cd".equalsIgnoreCase(statestr)) {
                    state = 2;
                } else if ("deleted".equalsIgnoreCase(statestr)) {
                    state = 3;
                } else {
                    return ChiiEmu.getS(ChiiEmu.I_STATE);
                }
                StringBuilder api = new StringBuilder("edit=1&state=").append(state);
                int j = s.indexOf("ed2k://|file|");
