...
public class JPanelOptDiv extends JPanel {
     ...
     *
     */
    private static final long serialVersionUID = -3825808037749159261L;
    public final static int H_EDK = 0, H_CRC = 1, H_MD5 = 2, H_SHA = 3, H_TTH = 4;
    ...
    public JPanelOptDiv() {
        ...
        for (int i = 0; i < cbHsh.length; i++) {
            cbHsh[i] = new JCheckBox(JPanelOptDiv.getHashName(i), false);
            pHash.add(cbHsh[i], cs);
        }
        cbHsh[JPanelOptDiv.H_EDK].setSelected(true);
        cbHsh[JPanelOptDiv.H_EDK].setEnabled(false);
    ...
    public void opts(Options o) {
        o.setB(Options.B_HASHCRC, cbHsh[JPanelOptDiv.H_CRC].isSelected());
        o.setB(Options.B_HASHMD5, cbHsh[JPanelOptDiv.H_MD5].isSelected());
        o.setB(Options.B_HASHSHA, cbHsh[JPanelOptDiv.H_SHA].isSelected());
        o.setB(Options.B_HASHTTH, cbHsh[JPanelOptDiv.H_TTH].isSelected());
...
//		o.setI(Options.I_USMOD, jcbModes.getSelectedIndex());
    ...
    public void optl(Options o) {
        cbHsh[JPanelOptDiv.H_CRC].setSelected(o.getB(Options.B_HASHCRC));
        cbHsh[JPanelOptDiv.H_MD5].setSelected(o.getB(Options.B_HASHMD5));
        cbHsh[JPanelOptDiv.H_SHA].setSelected(o.getB(Options.B_HASHSHA));
        cbHsh[JPanelOptDiv.H_TTH].setSelected(o.getB(Options.B_HASHTTH));
