...
public class Hyper {
    ...
    public static String error(String str) {
        return Hyper.color(Hyper.S_WARN, str);
    }

    public static String name(String str) {
        return Hyper.color(Hyper.S_NAME, str);
    }

    public static String name(Object o) {

        if (o != null) {
            return Hyper.color(Hyper.S_NAME, o.toString());
        }
        return "null";
    }

    public static String number(int i) {
        return Hyper.color(Hyper.S_NUMB, "" + i);
    }

    public static String number(String str) {
        return Hyper.color(Hyper.S_NUMB, str);
    }

    public static String enc() {
        return Hyper.S_WARN + Options.S_SEP + Hyper.S_NAME + Options.S_SEP + Hyper.S_NUMB;
    }
