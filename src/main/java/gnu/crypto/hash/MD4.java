...
public class MD4 extends BaseHash {
     ...
     */
    public MD4() {
        super("md4", MD4.DIGEST_LENGTH, MD4.BLOCK_LENGTH);
    }
    ...
    public boolean selfTest() {
        ...
        if (MD4.valid == null) {
            MD4.valid = Boolean.valueOf(MD4.DIGEST0.equals(BaseHash.toString(new MD4().digest())));
        }
        return MD4.valid.booleanValue();
    }

    @Override
    protected byte[] padBuffer() {
        int n = (int) (count % MD4.BLOCK_LENGTH);
